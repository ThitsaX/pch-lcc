...
public class PutQuotesError
        extends
        RetrofitRestApi<FspiopServiceFromPayee, ErrorInformationResponse, PutQuotesError.Response, ErrorInformationResponse> {
    ...
    public PutQuotesError(FspiopServiceFromPayee fspiopiopServiceForPayee, String endpoint, String fspiopSource,
                          String fspiopDestination, String fspiopDate, String accept, String contentType,
    ...
    protected Call<Response> call(ErrorInformationResponse request, Map<String, Object> extra)
        ...
        return this.fspiopiopServiceForPayee.putQuotesError(this.endpoint, this.fspiopSource, this.fspiopDestination,
