...
import com.thitsaworks.mojaloop.thitsaconnect.thitsaconnect.to.hub.support.FspiopErrorResponse;
...
public class PutPartiesError
        extends
        RetrofitRestApi<FspiopServiceFromPayee, ErrorInformationResponse, PutPartiesError.Response, ErrorInformationResponse> {
    ...
    public PutPartiesError(FspiopServiceFromPayee fspiopService, String endPoint,
                           String fspiopSource, String fspiopDestination, Currency currency, String fspiopDate,
    ...
    @Override
    protected Call<PutPartiesError.Response> call(ErrorInformationResponse request,
        ...
        return this.fspiopiopService.putPartiesError(this.endPoint, this.fspiopSource, this.fspiopDestination,
