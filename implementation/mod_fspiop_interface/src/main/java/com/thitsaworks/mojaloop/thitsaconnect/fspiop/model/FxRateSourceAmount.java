...
@JsonTypeName("FxRate_sourceAmount")
...
public class FxRateSourceAmount   {
  private @Valid Currency currency;
  private @Valid String amount;

  /**
   **/
  public FxRateSourceAmount currency(Currency currency) {
   ...
   **/
  public FxRateSourceAmount amount(String amount) {
    this.amount = amount;
    return this;
  }
 ...
 @Pattern(regexp="^([0]|([1-9][0-9]{0,17}))([.][0-9]{0,3}[1-9])?$")  public String getAmount() {
  ...
  public boolean equals(Object o) {
    ...
    FxRateSourceAmount fxRateSourceAmount = (FxRateSourceAmount) o;
    return Objects.equals(this.currency, fxRateSourceAmount.currency) &&
        Objects.equals(this.amount, fxRateSourceAmount.amount);
  }
  ...
  public String toString() {
    ...
    sb.append("class FxRateSourceAmount {\n");
