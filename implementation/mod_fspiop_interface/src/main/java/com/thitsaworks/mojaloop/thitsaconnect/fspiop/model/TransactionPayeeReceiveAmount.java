...
public class TransactionPayeeReceiveAmount   {
  ...
  /**
   **/
  public TransactionPayeeReceiveAmount currency(Currency currency) {
   ...
   **/
  public TransactionPayeeReceiveAmount amount(String amount) {
    this.amount = amount;
    return this;
  }
 ...
 @Pattern(regexp="^([0]|([1-9][0-9]{0,17}))([.][0-9]{0,3}[1-9])?$")  public String getAmount() {
  ...
  public boolean equals(Object o) {
    ...
    TransactionPayeeReceiveAmount transactionPayeeReceiveAmount = (TransactionPayeeReceiveAmount) o;
    return Objects.equals(this.currency, transactionPayeeReceiveAmount.currency) &&
        Objects.equals(this.amount, transactionPayeeReceiveAmount.amount);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransactionPayeeReceiveAmount {\n");
