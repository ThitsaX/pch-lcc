...
@JsonTypeName("FxQuotesIDPutResponse_conversionTerms")
...
public class FxQuotesIDPutResponseConversionTerms   {
  ...
  /**
   **/
  public FxQuotesIDPutResponseConversionTerms conversionId(String conversionId) {
  ...
  /**
   **/
  public FxQuotesIDPutResponseConversionTerms determiningTransferId(String determiningTransferId) {
  ...
  /**
   **/
  public FxQuotesIDPutResponseConversionTerms initiatingFsp(String initiatingFsp) {
  ...
  /**
   **/
  public FxQuotesIDPutResponseConversionTerms counterPartyFsp(String counterPartyFsp) {
  ...
  /**
   **/
  public FxQuotesIDPutResponseConversionTerms amountType(AmountType amountType) {
  ...
  /**
   **/
  public FxQuotesIDPutResponseConversionTerms sourceAmount(FxConversionSourceAmount sourceAmount) {
  ...
  /**
   **/
  public FxQuotesIDPutResponseConversionTerms targetAmount(FxConversionTargetAmount targetAmount) {
  ...
  /**
   **/
  public FxQuotesIDPutResponseConversionTerms expiration(String expiration) {
   ...
   **/
  public FxQuotesIDPutResponseConversionTerms charges(List<FxCharge> charges) {
 ...
 @Size(min=0,max=16)  public List<FxCharge> getCharges() {
  ...
  public FxQuotesIDPutResponseConversionTerms addChargesItem(FxCharge chargesItem) {
  ...
  public FxQuotesIDPutResponseConversionTerms removeChargesItem(FxCharge chargesItem) {
  ...
  /**
   **/
  public FxQuotesIDPutResponseConversionTerms extensionList(FxConversionExtensionList extensionList) {
  ...
  public boolean equals(Object o) {
    ...
    FxQuotesIDPutResponseConversionTerms fxQuotesIDPutResponseConversionTerms = (FxQuotesIDPutResponseConversionTerms) o;
    return Objects.equals(this.conversionId, fxQuotesIDPutResponseConversionTerms.conversionId) &&
        Objects.equals(this.determiningTransferId, fxQuotesIDPutResponseConversionTerms.determiningTransferId) &&
        Objects.equals(this.initiatingFsp, fxQuotesIDPutResponseConversionTerms.initiatingFsp) &&
        Objects.equals(this.counterPartyFsp, fxQuotesIDPutResponseConversionTerms.counterPartyFsp) &&
        Objects.equals(this.amountType, fxQuotesIDPutResponseConversionTerms.amountType) &&
        Objects.equals(this.sourceAmount, fxQuotesIDPutResponseConversionTerms.sourceAmount) &&
        Objects.equals(this.targetAmount, fxQuotesIDPutResponseConversionTerms.targetAmount) &&
        Objects.equals(this.expiration, fxQuotesIDPutResponseConversionTerms.expiration) &&
        Objects.equals(this.charges, fxQuotesIDPutResponseConversionTerms.charges) &&
        Objects.equals(this.extensionList, fxQuotesIDPutResponseConversionTerms.extensionList);
  }
  ...
  public String toString() {
    ...
    sb.append("class FxQuotesIDPutResponseConversionTerms {\n");
