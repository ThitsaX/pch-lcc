...
@JsonTypeName("FxCharge_sourceAmount")
...
public class FxChargeSourceAmount   {
  private @Valid Currency currency;
  private @Valid String amount;

  /**
   **/
  public FxChargeSourceAmount currency(Currency currency) {
   ...
   **/
  public FxChargeSourceAmount amount(String amount) {
    this.amount = amount;
    return this;
  }
 ...
 @Pattern(regexp="^([0]|([1-9][0-9]{0,17}))([.][0-9]{0,3}[1-9])?$")  public String getAmount() {
  ...
  public boolean equals(Object o) {
    ...
    FxChargeSourceAmount fxChargeSourceAmount = (FxChargeSourceAmount) o;
    return Objects.equals(this.currency, fxChargeSourceAmount.currency) &&
        Objects.equals(this.amount, fxChargeSourceAmount.amount);
  }
  ...
  public String toString() {
    ...
    sb.append("class FxChargeSourceAmount {\n");
