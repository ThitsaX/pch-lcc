...
@JsonTypeName("FxCharge_targetAmount")
...
public class FxChargeTargetAmount   {
  private @Valid Currency currency;
  private @Valid String amount;

  /**
   **/
  public FxChargeTargetAmount currency(Currency currency) {
   ...
   **/
  public FxChargeTargetAmount amount(String amount) {
    this.amount = amount;
    return this;
  }
 ...
 @Pattern(regexp="^([0]|([1-9][0-9]{0,17}))([.][0-9]{0,3}[1-9])?$")  public String getAmount() {
  ...
  public boolean equals(Object o) {
    ...
    FxChargeTargetAmount fxChargeTargetAmount = (FxChargeTargetAmount) o;
    return Objects.equals(this.currency, fxChargeTargetAmount.currency) &&
        Objects.equals(this.amount, fxChargeTargetAmount.amount);
  }
  ...
  public String toString() {
    ...
    sb.append("class FxChargeTargetAmount {\n");
